...
if __name__ == "__main__":
    parser = NorthMoraviaAndSilesiaNonSalmonidParser()
    parser.parse()
    ...
    parser.print_fishing_summary_given_by_id(["471046", "471047"])
    parser.print_fishing_summary_given_by_name(["MORAVA 16", "MORAVA 15"])

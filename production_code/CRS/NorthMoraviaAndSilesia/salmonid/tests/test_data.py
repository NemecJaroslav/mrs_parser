...
def get_expected_fishing_locations():
    return [
        ...
        FishingLocation("473002", "BEČVA ROŽNOVSKÁ 2", "MO ROŽNOV POD RADHOŠTĚM", 27.4,
        ...
        FishingLocation("473017", "BYSTŘICE VALAŠSKÁ 1 P", "MO VSETÍN", 4.0,
                        [(GPSCoordinate(49, 25, 12.295, "N"), GPSCoordinate(17, 57, 51.085, "E")),
                         (GPSCoordinate(49, 23, 41.621, "N"), GPSCoordinate(18, 9, 45.035, "E"))]),
        FishingLocation("473018", "ČELADENKA 1", "MO FRÝDLANT NAD OSTRAVICÍ", 7.0,
        ...
        FishingLocation("473019", "ČERNÁ OPAVA 1", "MO VRBNO POD PRADĚDEM", 16.0,
                        [(GPSCoordinate(50, 7, 32.177, "N"), GPSCoordinate(17, 22, 47.336, "E")),
                         (GPSCoordinate(50, 10, 49.228, "N"), GPSCoordinate(17, 17, 12.07, "E"))]),
        FishingLocation("473021", "ČERVENÝ POTOK 1", "MO JAVORNÍK", 3.0,
        ...
        FishingLocation("473038", "LIBINA 1 P", "MO UNIČOV", 2.4,
                        [(GPSCoordinate(49, 52, 53.96, "N"), GPSCoordinate(17, 5, 7.215, "E"))]),
        FishingLocation("473039", "LOMNÁ 1", "MO JABLUNKOV", 4.0,
        ...
        FishingLocation("473059", "ODRA 8", "MO VÍTKOV", 19.0,
        ...
        FishingLocation("473076", "OSTRAVICE 4", "MO FRÝDLANT NAD OSTRAVICÍ", 21.0,
                        [(GPSCoordinate(49, 36, 27.095, "N"), GPSCoordinate(18, 21, 32.348, "E")),
                         (GPSCoordinate(49, 30, 44.755, "N"), GPSCoordinate(18, 24, 56.071, "E"))]),
        FishingLocation("473077", "OSTRAVICE 6", "MO FRÝDLANT NAD OSTRAVICÍ", 6.0,
        ...
        FishingLocation("473108", "JIČÍNKA 1P", "MO NOVÝ JIČÍN", 4.0,
        ...
        FishingLocation("473301", "ČERNÝ POTOK 1", "MO BRUNTÁL", 4.0,
